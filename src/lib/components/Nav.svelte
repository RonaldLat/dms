...
<nav class=" p-4 flex justify-between z-50">
    ...
    {#if !$currentUser}
        <button
            ...
            type="button"
            class="text-white bg-gradient-to-r from-violet-500 via-violet-600 to-violet-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-violet-300 dark:focus:ring-violet-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
            >Register</button
        >
    {/if}
    {#if $currentUser}
